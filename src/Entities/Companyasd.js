...
const CompanyasdFilter = (props) => (
  <Filter {...props}>
    {/* <TextInput label="Search" source="q" alwaysOn /> */}
    <ReferenceInput label="Companyasd" source="name" reference="companyasd" allowEmpty>
      <SelectInput optionText="name" />
    </ReferenceInput>
  </Filter>
);

export const CompanyasdList = (props) => {

  return <List 
    {...props} 
    actions={<ListActions />}
    // filters={<CompanyasdFilter />}
  >
    <Datagrid>
      <EditButton />
...
export const CompanyasdEdit = props => (
  <Edit {...props}>
    <SimpleForm>
...
export const CompanyasdCreate = props => (
  <Create {...props}>
    <SimpleForm>
      <TextInput source="name" />
    </SimpleForm>
